...
class AutoGameEvent042Raid(AutoGame):
	...
	def initAcount(self):
		...
		self.mailaddress = "sho.draque118@docomo.ne.jp"
		self.password = "sho.draque118"
	...
	def insertDate(self):
		...
		eventpt #/html/body/div/div[2]/div[8]/table/tbody/tr[1]/td[3]/div
		gold
		fiendpt
		ticket
		...
		data = date + "," + "\n"
		print data
		f = open('C:\User_Program\labyrinth\.csv', 'a+') # 書き込みモードで開く
		f.write(data) # 引数の文字列をファイルに書き込む
		f.close() # ファイルを閉じる
